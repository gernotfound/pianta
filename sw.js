const CACHE_NAME = 'piante-pro-v4.3.0';
    ...
    event.respondWith(
        caches.match(req).then(cachedResponse => {
            ...
            const fetchPromise = fetch(req).then(networkResponse => {
                ...
                // Fallback corretto per evitare errori di MIME type
                if (req.destination === 'image') {
                    return new Response('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" fill="#f0f0f0"/><text x="50" y="50" dominant-baseline="middle" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#999">No Img</text></svg>', {
